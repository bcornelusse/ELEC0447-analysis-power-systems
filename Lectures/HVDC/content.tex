...
\section[Overview of HVDC applications \\ \small{Introduction of former course "ELEC0445 - HVDC grids"}]{Overview of HVDC applications}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Have a look at the video ``War of the currents'' at \href{https://www.youtube.com/watch?v=dIfIRj0Crc8}{\underline{YouTube}}.
...
\end{itemize}
    ...
    \begin{center}
    \includegraphics[width=\linewidth]{images/Cahora_Bassa.png}
    \end{center}
\end{columns}
\end{frame}
...
Based on Insulated Gate Bipolar Transistors (IGBT), used as \textit{self-commutating} switches.
...
\section[Components of an LCC HVDC link \\ \small{Extract of chapter 1 of former course "ELEC0445 - HVDC grids"}]{Components of an LCC HVDC link}
...
\begin{columns}
    \column{0.6\textwidth}    
    \begin{center}
        \includegraphics[trim=0.5cm 0cm 0.5cm 0cm, clip, width=\linewidth]{images/typical-HVDC1.png}
    \end{center}
    \column{0.4\textwidth} 
    \begin{itemize}
...
\begin{columns}
    \column{0.6\textwidth}    
    \begin{center}
        \includegraphics[trim=0.5cm 0cm 0.5cm 0cm, clip, width=\linewidth]{images/typical-HVDC2.png}
    \end{center}
    \column{0.4\textwidth} 
    \begin{itemize}
...
\begin{columns}
    \column{0.6\textwidth}    
    \begin{center}
        \includegraphics[trim=0.5cm 0cm 0.5cm 0cm, clip, width=\linewidth]{images/typical-HVDC3.png}
    \end{center}
    \column{0.4\textwidth} 
    \begin{itemize}
...
\begin{columns}
    \column{0.6\textwidth}    
    \begin{center}
        \includegraphics[trim=0cm 0cm 0.5cm 0cm, clip, width=\linewidth]{images/typical-HVDC4.png}
    \end{center}
\column{0.4\textwidth} 
    \begin{itemize}
...
\begin{columns}
    \column{0.6\textwidth}    
    \begin{center}
        \includegraphics[trim=0.5cm 0cm 0.5cm 0cm, clip, width=\linewidth]{images/typical-HVDC5.png}
\end{center}
\column{0.4\textwidth} 
\begin{itemize}
...
\begin{columns}
    \column{0.6\textwidth}    
    \begin{center}
        \includegraphics[trim=0.5cm 0cm 0.5cm 0cm, clip, width=\linewidth]{images/typical-HVDC6.png}
\end{center}
\column{0.4\textwidth} 
\begin{itemize}
...
\section[Thyristor valves \\  \small{A summary of chapter 2 of former course "ELEC0445 - HVDC grids"}]{Thyristor valves}
...
\begin{column}{0.6\linewidth}
\begin{itemize}
    \item Once the anode current $i$ reaches $I_L$, the \textit{latching current}, the thyristor switches to on-state
    ...
    \item if $i$ falls below $I_H$, the \textit{holding current}, the thyristor switches to off-state.
\end{itemize}
\end{column}
\end{columns}
...
\section[Operation of the LCC line\\ \small{A summary of chapter 3 of former course "ELEC0445 - High Voltage Direct Current grids"}] {Operation of the LCC line}
...
$$\cos \phi = \cos \alpha$$    (See \cite{padiyar1990hvdc}, page 49, conservation of power, AC to DC.)
\end{block}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item the rectifier maintains a Constant Current (CC) $I_d$ mode (increase power transfer by decreasing $\alpha$, which improves the power factor, and minimizes reactive power consumption)
        \item the inverter maintains Constant Extinction Angle (CEA) $\gamma$ mode, above the minimum value required to avoid commutation failure, for economical reasons.
    \end{itemize}
\end{itemize}
\end{frame}

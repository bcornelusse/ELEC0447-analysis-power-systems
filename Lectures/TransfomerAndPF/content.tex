...
The core is usually \alert{laminated}  to decrease losses.
\end{frame}
...
\begin{itemize}
\item Some transformers are equipped with a system allowing the $1:n$ ratio to be changed
...
\begin{itemize}
    ...
    \item Section 5.7 of Weedy or ELEC0014.
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item nominal power $3 V_N I_{\max} = 1400\text{ MVA}$
        \item phase shift adjustment: 35 positions, $+17/-17 \times 1.5^\circ$ (at no load)
    \end{itemize}
\end{enumerate}
...
\item quadrature adjustment: 21 positions, $+10/-10 \times 1.2^\circ$
\end{itemize}

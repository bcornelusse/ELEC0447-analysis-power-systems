...
\section{Impact of power flows on voltages}
...
\begin{frame}[allowframebreaks]{\textit{short-term instabilities}}
\begin{columns}
...
\begin{itemize}
    \item In transmission systems, because lines are inductive $X/R > 1$, 
    \begin{itemize}
        \item reactive power flows mostly impact voltage magnitudes, 
        \item active power flows mostly impact voltage angles.
    \end{itemize} 

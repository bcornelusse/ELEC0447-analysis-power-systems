...
\begin{frame}{This lecture expands on}
    \begin{itemize}
      ...
      \item Chapter 12 from Ned Mohan's book (summarized by Pr. Louis Wehenkel).
...
\begin{frame}{Why control power systems?}
  \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item \alert{around nominal value of frequency $f_n$: $50 \pm 0.2$  Hz in Europe (in steady state)}
...
\begin{frame}{How to use these control resources?}
    ...
    \end{block}
    Later, we will address voltage control and also introduce other problems related to transient stability.
\end{frame}
...
\begin{frame}{Speed governor transfer function (...)}
    \begin{itemize}
      ...
      \item In the feedback branch, $z$ is compared to $z^o$ and scaled by the droop coefficient $\sigma$ to yield a second error signal
...
\begin{frame}{Generator power correction}
  It is the output of a Proportional-Integral controller:
    \begin{itemize}
    ...
    The correction is then distributed over the generators participating in secondary frequency control:
    \begin{itemize}
...
\begin{frame}{Control resources}
    ...
    Which of these control resources are the main levers for frequency stability?
      \begin{itemize}
          \item Adjust synchronous generators' field current

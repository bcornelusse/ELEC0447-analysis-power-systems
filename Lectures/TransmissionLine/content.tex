...
\begin{frame}{What will we learn today?}
    ...
    \end{itemize}
    You will be able to do exercises 4.3, 4.4, 4.6, 4.7, 4.8, 4.9, 4.10, 4.11, 4.12, Lab4 (power-flow in python), 5.1, 5.2, 5.5, 5.6 from Ned Mohan's book.
\end{frame}
...
\begin{frame}{Definition}
    \begin{itemize}
        ...
        \item Underground cables are more and more used. They can be modeled in a similar way as overhead transmission lines, but they have different properties.
    \end{itemize}
\end{frame}
...
\begin{columns}
    ...
    \begin{column}{0.56\textwidth}
        Skin depth (depth at which decay of current density is $1/e$ of surface density):\\[\baselineskip]
        \begin{tabular}{l r r}
...
\begin{columns}
    ...
    \end{column}
    \begin{column}{0.4\textwidth}
    Dots are obtained with the $\pi$ model, while solid lines are from the distributed model. The approximation error grows for $l > 300$ km.
